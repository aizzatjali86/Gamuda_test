...
Prerequisites: Python 3.11 or higher and Node.js 18 or higher are required.

Environment Configuration: Define the GOOGLE_API_KEY and PORT in a .env file at the project root.
